    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-md-3">
            	...
            	<?php endif; ?>
                <h4 class="subtitle">Permanece en contacto</h4>
                <ul class="nav">
                	<?php if ( $facebook ) : ?>
                    <li class="nav-item">
            ...
            <div class="col-12 col-md-3">
                ...
                <ul class="nav flex-column">
                    <li class="nav-item">
                        <a href="https://www.mozilla.org/es-ES/firefox/new/" class="nav-link" target="_blank">Descargar Firefox</a>
                    </li>
                    <li class="nav-item">
                        <a href="https://www.mozilla.org/es-ES/firefox/" class="nav-link" target="_blank">Escritorio</a>
                    </li>
                    <li class="nav-item">
                        <a href="https://www.mozilla.org/es-ES/firefox/mobile/" class="nav-link" target="_blank">Móvil</a>
                    </li>
                    <li class="nav-item">
